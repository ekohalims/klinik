...
<div class="row" style="margin-top: 15px;border-top: solid 2px #12a89d;padding-top: 5px;border-radius:3px;box-shadow: 1px 1px 3px #ccc;">
	...
	<div class="col-md-8" style="padding: 10px;">
		<label><u>Permintaan Laboratorium</u></label>
		<table class="table table-striped table-bordered">
			...
			<tbody>
				<?php
					$dataOrder = $this->modelOrderLaboratorium->dataOrder($row->noPendaftaran);
		...
		<div class="form-group" style="text-align: right;margin-top: 10px;">
			...
			?>
			<a href="<?php echo base_url('orderLaboratorium/processOrder/'.$encoded); ?>" class="btn btn-info"><i class="fa fa-eye"></i> Detail</a>
		</div>
	</div>
</div>
<?php } ?>