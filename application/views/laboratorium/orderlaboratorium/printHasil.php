    ...
    <div class="row">
        <div class="col-md-6">
            <div class="page-title"> 
            	<h3 class="title"><i class="fa fa-file-word-o"></i> Hasil Laboratorium</h3> 
        	    <h6> <a href="<?php echo base_url('orderLaboratorium'); ?>">Order Laboratorium</a> / <a href="<?php echo base_url('orderLaboratorium/processOrder/'.$this->uri->segment(3)); ?>"> Proses Permintaan</a> / Cetak Hasil</h6>
            </div>
        </div>
            ...
            <div class="portlet-body" id="area-print">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                        <h6 style="font-weight:bold;">Pemeriksaan : <?php echo $dt->namaLab; ?></h6>
                        <?php echo $dt->hasil; ?>
                        <?php echo "<br>"; } ?>
                    </div>
                </div>
