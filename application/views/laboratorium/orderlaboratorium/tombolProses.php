...
<?php } elseif($status==2){ ?>
<a  onclick="printContent('area-print')" class='btn btn-success'><i class="fa fa-print"></i> Print Hasil</button>
<?php } ?>

<script type="text/javascript">
    var urlUpdateStatus = "<?php echo base_url('orderLaboratorium/updateStatusOrder'); ?>";
    ...
    function updateDokterPemeriksa(){
        var urlUpdateDokter = "<?php echo base_url('orderLaboratorium/updateDokterPemeriksa'); ?>";
        var idDokter = $('#dokter').val();
