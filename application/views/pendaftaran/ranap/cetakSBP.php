                            ...
                            <div class="col-md-12" id="print-area">
                                <table width="100%">
                                        ...
                                        <td colspan="2"> <!--header sjp-->
                                            <table width="100%">
                                                <tr style="font-size:15px;font-weight:bold;">
                                                    ...
                                                    <td style="vertical-align:middle;">SURAT BUKTI PELAYANAN (SBP) <br> RAWAT INAP</td>
                                        ...
                                        <td width="50%" style="vertical-align:top;padding-top:5px;">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><?php echo $headerSJP->namaRuang." / ".$headerSJP->kelasruang; ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td style="vertical-align:top;">RUANG ICU / ICCU</td>
                                                    <td style="vertical-align:top;">:</td>
                                                    <td style="vertical-align:top;">Tanggal Masuk : <br> Tanggal Keluar : </td>
                                                </tr>   
                                        ...
                                        <td style="padding-top:10px;" colspan="2">
                                            <table width="100%">
                                                ...
                                                <tr style="height:40px;">
                                                    <td style="vertical-align:top;padding-top:5px;" width="20%">DIAGNOSA UTAMA</td>
                                    ...
                                    <tr style="height:30px;vertical-align:bottom;">
                                        <td colspan="2">Keadaan Waktu Keluar :</td>
                                    </tr>

                                    <tr>
                                        <td colspan="2">
                                            1. <img src="<?php echo base_url('assets/box.png'); ?>" height="25px"/> Sembuh &nbsp
                                            2. <img src="<?php echo base_url('assets/box.png'); ?>" height="25px"/> Pindah RS &nbsp
                                            3. <img src="<?php echo base_url('assets/box.png'); ?>" height="25px"/> Pulang Atas Permintaan Sendiri &nbsp
                                            4. <img src="<?php echo base_url('assets/box.png'); ?>" height="25px"/> Meninggal &nbsp
                                            5. <img src="<?php echo base_url('assets/box.png'); ?>" height="25px"/> Lain-lain &nbsp
