    ...
    <div class="row">
        <div class="col-md-6">
            <div class="page-title"> 
                ...
                <h6><a href="<?php echo base_url('pembatalanTransaksi'); ?>">Pembatalan Transaksi</a> / Daftar Transaksi Pasien</h6>
            </div>
        </div>

        <div class="col-md-6" style="text-align:right;">
            <a href="#myModal" data-toggle="modal" id="pembatalanTrx" class="btn btn-danger btn-rounded"><i class="fa fa-eraser"></i> Batalkan Keseluruhan Transaksi</a>
        </div>
    </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row" style="margin-top:20px;">
                    <div class="col-md-6">
                        <table class="table">
                            <tr>
                                <td style="font-weight:bold;"><i class="fa fa-stethoscope"></i> Pelayanan</td>
                            </tr>
