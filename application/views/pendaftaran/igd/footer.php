...
<script type="text/javascript">
    $('#cariPasien').on("click",function(){
        ...
        var urlCariPasien = "<?php echo base_url('pendaftaranIGD/cariPasien'); ?>";
    ...
    $('#daftarPasien').on("click",function(){
        var url = "<?php echo base_url('pendaftaranIGD/tablePasienModal'); ?>";
        $('.modal-body').load(url);
    });

    $('#pasienBaru').on("click",function(){
        var url = "<?php echo base_url('pendaftaranIGD/formPasienBaru'); ?>";
    ...
    $('#jenisRujukan').change(function(){
        var jenisRujukan = $(this).val();
            ...
            var url = "<?php echo base_url('pendaftaranIGD/asalRujukanForm'); ?>";
            $('#asalRujukanForm').load(url,{jenisRujukan : jenisRujukan});
        
    });

    $('#launchRujukan').on("click",function(){
        var url = "<?php echo base_url('pendaftaranIGD/formTambahAsalRujukan'); ?>";
    ...
    $('#simpanRujukan').on("click",function(){
        ...
        if(namaRujukan==''){
            ...
            var urlSimpan = "<?php echo base_url('pendaftaranIGD/simpanAsalRujukanSQL'); ?>";
    ...
    $(document).on("click",'#submitPendaftaran',function(){
        ...
        var pelayanan = $('#pelayananIGD').val();
        ...
        var urlSubmitPendaftaran = "<?php echo base_url('pendaftaranIGD/submitPendaftaran'); ?>";

        if(idDokter=='' || radioLayanan=='' || idPasien==''){
            if(idDokter==''){
            ...
            $.ajax({
                ...
                success : function(response){
                    var urlReplace = "<?php echo base_url('pendaftaranIGD') ?>";
    ...
    $('.layanan').change(function(){
        ...
        if(idLayanan==2){
            var url = "<?php echo base_url('pendaftaranIGD/dropdownAsuransi'); ?>";
            $('#tanggunganAsuransi').load(url);

            var urlKartu = "<?php echo base_url('pendaftaranIGD/noKartuForm'); ?>";
    ...
    function tampilkanDataPasien(noPasien,searchBy){
        var urlPasienJSON = "<?php echo base_url('pendaftaranIGD/tampilkanPasienJSON'); ?>";
    ...
    function tampilkanDataPasienLangsung(noPasien){
        var urlPasienJSON = "<?php echo base_url('pendaftaranIGD/tampilkanPasienJSONLangsung'); ?>";
    ...
    $('#simpanPasien').on("click",function(){
        ...
        if(noID=='' || namaLengkap=='' || jenisKelamin=='' || noHP==''){
            ...
            var urlSimpanPasien = "<?php echo base_url('pendaftaranIGD/simpanPasienSQL'); ?>";
    ...
    $('#dokter').select2({
        ...
        ajax: {
            url : '<?php echo base_url('pendaftaranIGD/select2Dokter'); ?>',
            dataType : 'json',
            quietMillis : 500,
            method : "GET",
