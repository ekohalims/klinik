    ...
    <div class="row">
        <div class="col-md-6">
            <div class="page-title"> 
                <h3 class="title"><i class="fa fa-ambulance"></i> Pendaftaran IGD</h3> 
                <h6><a href="<?php echo base_url('pendaftaran IGD'); ?>">IGD</a> / Pendaftaran IGD</h6>
            </div>
        </div>
                    ...
                    <div class="col-md-6">
                        <table width="100%">
                            ...
                            <tr style="height:50px;">
                                ...
                                <td>:</td>
                                <td>
                                    <select class="form-control" id="pelayananIGD">
                                        <?php
                                            foreach($pelayanan as $pl){
                                        ?>
                                        <option value="<?php echo $pl->id; ?>"><?php echo $pl->pelayanan; ?></option>
                                        <?php } ?>
                                    </select>                          
                                </td>
                            </tr>
