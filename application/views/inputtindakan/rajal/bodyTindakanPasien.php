...
<div class="wraper container-fluid">
    <div class="page-title"> 
    	<h3 class="title"><i class="fa fa-stethoscope"></i> Input Tindakan Pasien Rawat Jalan</h3> 
        <h6> <a href="<?php echo base_url('inputTindakanRajal'); ?>">Rawat Jalan</a> / Input Tindakan</h6>
	</div>
