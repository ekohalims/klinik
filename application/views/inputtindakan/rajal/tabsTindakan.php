...
<div id="myModal" class="modal fade fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusTindakan",function(){
        ...
        swal({   
            ...
            var urlHapusTindakan = "<?php echo base_url('inputTindakanRajal/hapusTindakan'); ?>";
    ...
    $(document).on("change","#selisih",function(){
        ...
        var url = "<?php echo base_url('inputTindakanRajal/updateSelisih'); ?>";
    ...
    $(document).on("change","#qty",function(){
        ...
        var url = "<?php echo base_url('inputTindakanRajal/updateQty'); ?>";
    ...
    function tampilkanCart(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanRajal/tampilkanCartTindakan'); ?>";
    ...
    function tampilkanDaftarTindakan(){
        var urlTampilkanDaftarTindakan = "<?php echo base_url('inputTindakanRajal/tampilkanDaftarTindakan'); ?>";
    ...
    function addTindakan(idTindakan,dokter){
        var urlAddTindakan = "<?php echo base_url('inputTindakanRajal/addTindakanSQL'); ?>";
    ...
    function tampilkanKeteranganTindakan(id){
        var urlCatatan = "<?php echo base_url('inputTindakanRajal/keteranganTindakan'); ?>";
