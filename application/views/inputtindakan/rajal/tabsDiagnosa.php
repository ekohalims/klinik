...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusCartDiag",function(){
    	var id = this.id;
    	var urlHapus = "<?php echo base_url('inputTindakanRajal/hapusCartDiag'); ?>";
    ...
    function tampilkanCartLab(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanRajal/tampilkanCartDiagnosa'); ?>";
    ...
    function loadItem(){
        var urlItem = "<?php echo base_url('inputTindakanRajal/datatableDiagnosa'); ?>";
    ...
    function addDiagnosa(id,keterangan){
        var urlOrderLab = "<?php echo base_url('inputTindakanRajal/addDiagnosaOnPasien'); ?>";
    ...
    function tampilkanKeteranganDiagnosa(id){
        var urlCatatan = "<?php echo base_url('inputTindakanRajal/keteranganDiagnosa'); ?>";
