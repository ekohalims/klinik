...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusCartLab",function(){
    	var idLab = this.id;
    	var urlHapus = "<?php echo base_url('inputTindakanRajal/hapusCartLab'); ?>";
    ...
    function tampilkanCartLab(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanRajal/tampilkanCartLab'); ?>";
    ...
    function tampilkanCatatanLab(id){
        var urlCatatan = "<?php echo base_url('inputTindakanRajal/catatanLab'); ?>";

        $('.modal-body').load(urlCatatan,{id : id});
    }

    function orderLab(id,catatan){
        var urlOrderLab = "<?php echo base_url('inputTindakanRajal/orderLab'); ?>";
    ...
    function loadItem(){
        var urlItem = "<?php echo base_url('inputTindakanRajal/datatableLab'); ?>";
