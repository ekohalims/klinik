    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myLargeModalLabel">Pelayanan</h4>
            </div>
...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusTindakan",function(){
        ...
        swal({   
            ...
            var urlHapusTindakan = "<?php echo base_url('inputTindakanIGD/hapusTindakan'); ?>";
    ...
    $(document).on("change","#selisih",function(){
        ...
        var url = "<?php echo base_url('inputTindakanIGD/updateSelisih'); ?>";
    ...
    $(document).on("change","#qty",function(){
        ...
        var url = "<?php echo base_url('inputTindakanIGD/updateQty'); ?>";
    ...
    function tampilkanCart(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanIGD/tampilkanCartTindakan'); ?>";
    ...
    function tampilkanDaftarTindakan(){
        var urlTampilkanDaftarTindakan = "<?php echo base_url('inputTindakanIGD/tampilkanDaftarTindakan'); ?>";
    ...
    function addTindakan(idTindakan,dokter){
        var urlAddTindakan = "<?php echo base_url('inputTindakanIGD/addTindakanSQL'); ?>";
    ...
    function tampilkanKeteranganTindakan(id){
        var urlCatatan = "<?php echo base_url('inputTindakanIGD/keteranganTindakan'); ?>";
