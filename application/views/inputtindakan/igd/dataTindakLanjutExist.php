...
<script type="text/javascript">
	...
	$(document).on("change",'#tanggalKontrol',function(){
		...
		var url = "<?php echo base_url('inputTindakanIGD/updateTanggalKontrol'); ?>";
	...
	$(document).on("change","#spesialis",function(){
		...
		var url = "<?php echo base_url('inputTindakanIGD/updateRujukanPasien'); ?>";
	...
	function simpanTindakLanjut(){
		...
		var simpanTindakLanjut = "<?php echo base_url('inputTindakanIGD/simpanTindakLanjut'); ?>";
	...
	function loadAdditionalForm(id){
		if(id=='1'){
			var url = "<?php echo base_url('inputTindakanIGD/formKontrolKembali'); ?>";
			$('#additionalForm').load(url,{noPendaftaran : noPendaftaran});
		} else if(id==4){
			var url = "<?php echo base_url('inputTindakanIGD/formRujukPasien'); ?>";
			$('#additionalForm').load(url,{noPendaftaran : noPendaftaran});
		} else {
			$.ajax({
				method : "POST",
				url : "<?php echo base_url('inputTindakanIGD/kosongkanRujukanDanTanggalKontrol'); ?>",
