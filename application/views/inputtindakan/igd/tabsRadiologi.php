...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusCartRad",function(){
    	var idRad = this.id;
    	var urlHapus = "<?php echo base_url('inputTindakanIGD/hapusCartRad'); ?>";
    ...
    function tampilkanCartLab(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanIGD/tampilkanCartRad'); ?>";
    ...
    function orderRad(id,catatan){
        var urlOrderLab = "<?php echo base_url('inputTindakanIGD/orderRad'); ?>";
    ...
    function loadItem(){
        var urlItem = "<?php echo base_url('inputTindakanIGD/datatableRad'); ?>";
    ...
    function tampilkanCatatanRad(id){
        var urlCatatan = "<?php echo base_url('inputTindakanIGD/catatanRad'); ?>";
