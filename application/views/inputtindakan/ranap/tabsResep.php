...
<script type="text/javascript">
    ...
    function tampilkanItemModal(idKategori,search,limitStart){
		var url = "<?php echo base_url('inputTindakanRanap/tampilkanItemObat'); ?>";
		$.ajax({
			method : "POST",
			url : url,
    ...
    $(document).on("click",".hapusResep",function(){
        ...
        var urlHapusResep = "<?php echo base_url('inputTindakanRanap/hapusResep'); ?>";
    ...
    function tampilkanCart(){
    	var urlTampilkanCart = "<?php echo base_url('inputTindakanRanap/tampilkanCartResep'); ?>";
