...
<div class="wraper container-fluid">
    <div class="page-title"> 
    	<h3 class="title"><i class="fa fa-stethoscope"></i> Input Tindakan Pasien Rawat Inap</h3> 
        <h6> <a href="<?php echo base_url('inputTindakanRanap'); ?>">Rawat Inap</a> / Input Tindakan</h6>
	</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="border-bottom: solid 1px #ccc;padding-bottom: 5px;text-align: right;">
                            <a class="btn btn-warning btn-rounded" id="tindakanSelesai"><i class="fa fa-ticket"></i> Pasien Pulang</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top: 10px;">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs"> 
                            ...
                            <li class=""> 
                                <a data-toggle="tab" class="tabsMedic" id="kamar"> 
                                    <span>Kamar</span> 
                                </a> 
                            </li>
