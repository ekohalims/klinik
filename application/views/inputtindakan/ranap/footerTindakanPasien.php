...
<script type="text/javascript">
    ...
    $('.tabsMedic').on("click",function(){
        var tabs = this.id;
        var urlContentTabs = "<?php echo base_url('inputTindakanRanap/tabsContent'); ?>";
    ...
    $('#tindakanSelesai').on("click",function(){
        ...
        swal({
            ...
            var urlTindakanSelesai = "<?php echo base_url('inputTindakanRanap/tindakanApprove'); ?>";
            ...
            $.ajax({
                ...
                success : function(){
                    ...
                    window.location.replace("<?php echo base_url('inputTindakanRanap'); ?>");
                }
            });
    ...
    function loadCatatan(){
        var urlCatatan = "<?php echo base_url('inputTindakanRanap/tabsContent'); ?>";
        var tabs="catatan";
    ...
    function loadDaftarBiaya(noPendaftaran){
        var url = "<?php echo base_url('inputTindakanRanap/daftarBiaya'); ?>";
