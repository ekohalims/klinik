                                ...
                                <tr>
                                    <td>
                                                ...
                                                <td style="vertical-align: top;">
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>:</td>
                                                            <td><?php echo $dataOrder->payment_type." ".$dataOrder->account; ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table style="margin-top: 5px;" width="100%"> 
                                            ...
                                            <tr>
                                                <td style="text-align: center;font-size: 13px;"><b>JUMLAH BAYAR</b></td>
                                                <td>Rp.</td>
                                                <td style="text-align: right;font-weight: bold;font-size: 13px; ">
                                                    <?php
                                                        echo number_format($dataOrder->jumlahBayar,'0',',','.');
                                                    ?>
                                                </td>
                                            </tr>

                                            <?php
                                                if($dataOrder->typeBayar==1){
                                            ?>
                                            <tr>
                                                <td style="text-align: center;font-size: 13px;"><b>KEMBALI</b></td>
                                                <td>Rp.</td>
                                                <td style="text-align: right;font-weight: bold;font-size: 13px; ">
                                                    <?php
                                                        echo number_format($dataOrder->kembali,'0',',','.');
                                                    ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
