...
<script type="text/javascript">
    ...
    $('#jenisPembayaran').change(function(){
        var id = $(this).val();
        var url = "<?php echo base_url('kasir/subAccountForm'); ?>";
    ...
    $('#jumlahBayar').change(function(){
        ...
        var urlCekMaxPay = "<?php echo base_url('kasir/maxPayPiutang'); ?>";
    ...
    $('#prosesPembayaran').on("click",function(){
        ...
        var urlProsesPembayaran = "<?php echo base_url('kasir/prosesPembayaranPiutang'); ?>";
    ...
    $(document).on("click","#updateStatusTrx",function(){
        swal({   
                ...
                var url = "<?php echo base_url('kasir/updateStatusPiutang'); ?>";
    ...
    function loadDataTransaksi(){
        var urlDataTransaksi = "<?php echo base_url('kasir/dataPembayaranPiutang'); ?>";
    ...
    function loadRiwayatPembayaran(){
        var urlRiwayatDataPembayaran = "<?php echo base_url('kasir/dataRiwayatPembayaran'); ?>";
    ...
    function loadButtonTrx(){
        var url = "<?php echo base_url('kasir/buttonPiutang'); ?>";
    ...
    function loadStatusTrx(){
        var url = "<?php echo base_url('kasir/statusPiutang'); ?>";
