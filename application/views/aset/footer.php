 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            $('.collapseStok').on("click",function(){
                var idProduk = this.id;

                var url = "<?php echo base_url('akumulasiStok/viewAllStok'); ?>";
                ...
                $.ajax({
                            ...
                            beforeSend  : function(){
                                            $('#viewAllStok'+idProduk).html("<td colspan='3'>Loading...</td>");
                                          },
                            success     : function(data){
                                            $('#viewAllStok'+idProduk).html(data);
                                          }
                });
