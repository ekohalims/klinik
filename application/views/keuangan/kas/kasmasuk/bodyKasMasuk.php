    ...
    <div class="row">
        <div class="col-md-6">
            <div class="page-title"> 
                <h3 class="title"><i class="fa fa-arrow-circle-right"></i> Kas Masuk</h3> 
                <h6> <a href="<?php echo base_url('kasDanBank'); ?>">Kas dan Bank</a> / Kas Masuk</h6>
            </div>
        </div>

        <div class="col-md-6" style="text-align:right;vertical-align:bottom;">
            <a href="<?php echo base_url('kasDanBank/listKasMasuk'); ?>" class="btn btn-default btn-rounded"><i class='fa fa-list'></i> List Kas Masuk</a>
        </div>
    </div>
                    ...
                    <div class="col-md-6">
                        <form role="form">
                            ...
                            <div class="form-group" style="text-align:right;">
                                <a class='btn btn-success btn-rounded' id="simpanKasMasuk"><i class='fa fa-save'></i> Simpan</a>
                            </div>
                        </form>
                    </div>
                </div>
