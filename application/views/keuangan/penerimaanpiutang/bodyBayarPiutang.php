    ...
    <div class="row">
        <div class="col-md-6">
            <div class="page-title"> 
                <h3 class="title"><i class="fa fa-credit-card"></i> Penerimaan Piutang</h3> 
                <h6> <a href="<?php echo base_url('penerimaanPiutang'); ?>">Penerimaan Piutang</a> / Pembayaran Piutang</h6>
            </div>
        </div>
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            <div class="col-md-12" style="text-align:right;">
                                <a target="__blank" href="<?php echo base_url('penerimaanPiutang/viewInvoice/'.$noInvoie) ?>" class="btn btn-success btn-rounded"><i class="fa fa-print"></i> Cetak Invoice</a>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <table style="width:100%;">
                                    <tr style="border-bottom:solid 1px #ccc;border-top:solid 3px #12a89d;height:50px;">
                                        ...
                                        <td style="text-align:right;"><a class="btn btn-success btn-rounded" href="<?php echo base_url('penerimaanPiutang/cetakBuktiBayar/'.$this->uri->segment(3)); ?>"><i class="fa fa-print"></i> Cetak Bukti bayar</a></td>
                                    </tr>
                                </table>
