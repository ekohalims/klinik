 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#viewReport').on("click",function(){
                ...
                var jenisLaporan = $("input[name='jenisLaporan']:checked").val();

                var urlViewReport = "<?php echo base_url('laporan/viewReportPengeluaranObat'); ?>";
                ...
                $.ajax({
                    method : "POST",
                    url : urlViewReport,
                    data : {dateStart : dateStart, dateEnd : dateEnd, poli : poli, dokter : dokter, pasien : pasien, jenisLaporan : jenisLaporan},
                    beforeSend : function(){
