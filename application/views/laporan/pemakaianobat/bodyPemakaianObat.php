    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="page-title"> 
		    	<h3 class="title"><i class="fa fa-line-chart"></i> Laporan Pemakaian Obat</h3> 
			</div>
    	</div>
				...
				<div id="portlet2" class="panel-collapse collapse in">
				   	<div class="portlet-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" name="jenisLaporan" value="akumulasi"/>Akumulasi
                            <input type="radio" name="jenisLaporan" value="perpendaftaran"/>Berdasarkan Invoice
                        </div>
