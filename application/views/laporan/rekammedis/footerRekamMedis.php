 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#diagnosa').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('laporan/select2Diagnosa'); ?>',
                    dataType    : 'json',
                    quietMillis : 500,
                    method      : "GET",
                    data: function (params) {
            ...
            $('#viewReport').on("click",function(){
                ...
                var urlViewReport = "<?php echo base_url('laporan/viewRekamMedis'); ?>";
                ...
                $.ajax({
                    method : "POST",
                    url : urlViewReport,
                    data : {dateStart : dateStart, dateEnd : dateEnd, poli : poli, dokter : dokter, pasien : pasien,diagnosa : diagnosa, jenis : jenis},
                    beforeSend : function(){
