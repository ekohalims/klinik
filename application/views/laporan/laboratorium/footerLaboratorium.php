 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#viewReport').on("click",function(){
                ...
                var itemLab = $('#itemLab').val();

                var urlViewReport = "<?php echo base_url('laporan/viewLaporanLaboratorium'); ?>";
                ...
                $.ajax({
                    method : "POST",
                    url : urlViewReport,
                    data : {dateStart : dateStart, dateEnd : dateEnd, dokter : dokter, pasien : pasien, itemLab : itemLab},
                    beforeSend : function(){
