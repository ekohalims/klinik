    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="page-title"> 
		    	<h3 class="title"><i class="fa fa-leanpub"></i> Laporan Hasil Radiologi</h3> 
			</div>
    	</div>
				   	...
				   	<div class="portlet-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <select class="select2" id="itemRadiologi">
                                <option value="">--Tampilkan Semua--</option>
                                
                                <?php
                                    foreach($listRadiologi as $lb){ 
                                ?>
                                <option value="<?php echo $lb->id; ?>"><?php echo $lb->namaRadiologi; ?></option>
                                <?php } ?>
                              </select>
                            </div>
                        </div>
