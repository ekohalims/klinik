...
<?php
    foreach($laporanRadiologi->result() as $row){
?>
...
<div class="row" style="margin-top:10px;">
    <div class="col-md-12">
        <table width="100%" border="1">
            <?php
                $itemRadiologi = $this->modelLaporan->itemRadiologiResult($row->noPendaftaran);

                foreach($itemRadiologi as $dt){
            ?>
            <tr style=";border-bottom:solid 1px grey;">
                <td style="font-weight:bold;padding-left:20px;"> 
                    <?php
                        echo $dt->namaRadiologi."<br>";
