    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="page-title"> 
		    	<h3 class="title"><i class="fa fa-money"></i> Laporan Pendapatan</h3> 
			</div>
    	</div>
				   	...
				   	<div class="portlet-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <select class="select2" id="typeBayar">
                              	<option value="">--Tampilkan Semua--</option>

                              	<?php foreach($typeBayar as $py){ ?>
                        ...
                        <div class="form-group" id="subAccount">
                        	<input type="hidden" id="subAccountValue" value="">
                        </div>
