 <!-- Page Content Ends -->
        ...
        <script type="text/javascript">
            ...
            $('#viewReport').on("click",function(){
                ...
                var urlViewReport = "<?php echo base_url('kartuStok/viewKartuStokGudang'); ?>";
                ...
                $.ajax({
                    method : "POST",
                    url : urlViewReport,
                    data : {dateStart : dateStart, dateEnd : dateEnd, item : item},
                    beforeSend : function(){
            ...
            $('#item').select2({
                ...
                ajax: {
                    url         : '<?php echo base_url('kartuStok/ajaxProduk'); ?>',
                    dataType    : 'json',
                    quietMillis : 500,
                    method      : "GET",
