                            ...
                            <div class="row">
                                <div class="col-md-12">
                        			...
                        			<div class="form-group" style="margin-top: 20px;height: 450px;" id="tableNiceScroll">
                                        ...
                                        Aktifkan Pajak ? <input type="checkbox" id="pajakCheckbox" value="1"/>
                                        <table class="table table-striped table-bordered" style="font-size: 12px;">
                        					<thead>
            	            					<tr style="font-weight: bold;">
                                                    ...
                                                    <td width="13%" align="center">Pajak</td>
                                                    <td width="13%" align="center">Grand Total</td>
            	            						<td width="3%"></td>
            	            					</tr>
                        					</thead>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-plus" style="color:#007223;"></i></span>
