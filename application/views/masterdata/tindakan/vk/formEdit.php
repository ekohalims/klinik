<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="kodeVK" value="<?php echo $tarif->kode; ?>"/>
        </div>
    </div>
                ...
                <thead>
                    ...
                    ?>
                        <tr id="row<?php echo $i; ?>">
                            ...
                            <td style="text-align:right;vertical-align:middle;"><a class="btn btn-danger btn-sm hapusVKRinci" id="<?php echo $i; ?>" data-kode_tarif="<?php echo $rc->kodeTarif; ?>"><i class="fa fa-trash"></i></a></td>
                        </tr>
                    <?php $i++; } ?>
                </thead>
