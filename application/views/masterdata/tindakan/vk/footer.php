...
<script type="text/javascript">
    ...
    $(document).on("click",".edit",function(){
        var id = this.id;
        var url = "<?php echo base_url('tindakan/formEditVK'); ?>";
    ...
    $(document).on("click",".hapusVKRinci",function(){
        var row = this.id;
        var kode = $(this).data('kode_tarif');
        var url = "<?php echo base_url('tindakan/hapusVKRinci'); ?>";
    ...
    $(document).on("click",".hapus",function(){
        var kode = this.id;
        var url = "<?php echo base_url('tindakan/hapusVK'); ?>";
    ...
    $('#tambah').on("click",function(){
        ...
        var url = "<?php echo base_url('tindakan/formTambahVK'); ?>";
        $('.modal-body').load(url);
        $('#myModal').modal('show');
    });
    ...
    $('#userForm').on("submit",function(){
        ...
        var url = "<?php echo base_url('tindakan/simpanVK'); ?>";
    ...
    function loadData(){
        var url = "<?php echo base_url('tindakan/loadTarifVK'); ?>";
