<div class="wraper container-fluid">
    <div class="page-title">
        <h3 class="title"><i class="fa fa-car"></i> Edit Harta Tetap</h3>
            ...
            <div class="portlet-body">
                    ...
                    <div class="col-md-6">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="<?php echo $currentAset->nama; ?>" id="nama">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" id='formKelompokHarta'>
                                    <select class="select2" id="kelompokHarta">      
                                        ...
                                        ?>
                                        <option value="<?php echo $row->id; ?>" <?php if($row->id==$currentAset->kelompok){echo "selected";} ?>><?php echo $row->nama; ?></option>                   
                                        <?php } ?>               
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control datepicker" id="tanggalBeli" value="<?php echo $currentAset->tanggalBeli; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="hargaBeli" value="<?php echo $currentAset->hargaBeli; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nilaiResidu" value="<?php echo $currentAset->nilaiResidu; ?>">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="col-md-6">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="umurEkonomis" value="<?php echo $currentAset->umurEkonomis; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class='form-control' id="metode">
                                        <option value="1" <?php if($currentAset->metode==1){echo "selected"; }?>>Tanpa Penyusutan</option>
                                        <option value="2" <?php if($currentAset->metode==2){echo "selected"; }?>>Garis Lurus</option>
                                        <option value="3" <?php if($currentAset->metode==3){echo "selected"; }?>>Saldo Menurun</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <select class="select2" id="akunHarta">
                                        ...
                                        <optgroup label="<?php echo $row->kodeAkun." - ".$row->namaAkun; ?>">
                                            ...
                                            ?>
                                            <option value="<?php echo $dt->kodeSubAkun; ?>" <?php if($dt->kodeSubAkun==$currentAset->akunHarta){echo "selected";} ?>><?php echo $dt->kodeSubAkun." - ".$dt->namaSubAkun; ?></option>
                                            <?php } ?>
                                        </optgroup>
                                        <?php } ?>
                                    </select>
                                    ...
                                    <select class="select2" id="akumulasiDepresiasi">
                                        ...
                                        <optgroup label="<?php echo $row->kodeAkun." - ".$row->namaAkun; ?>">
                                            <?php
                                                ...
                                                foreach($coaSub as $dt){
                                            ?>
                                            <option value="<?php echo $dt->kodeSubAkun; ?>" <?php if($dt->kodeSubAkun==$currentAset->akumulasiDepresiasi){echo "selected";} ?>><?php echo $dt->kodeSubAkun." - ".$dt->namaSubAkun; ?></option>
                                            <?php } ?>
                                        </optgroup>
                                        <?php } ?>
                                    </select>
                                    ...
                                    <select class="select2" id="depresiasi">
                                        ...
                                        <optgroup label="<?php echo $row->kodeAkun." - ".$row->namaAkun; ?>">
                                            <?php
                                                ...
                                                foreach($coaSub as $dt){
                                            ?>
                                            <option value="<?php echo $dt->kodeSubAkun; ?>" <?php if($dt->kodeSubAkun==$currentAset->depresiasi){echo "selected";} ?>><?php echo $dt->kodeSubAkun." - ".$dt->namaSubAkun; ?></option>
                                            <?php } ?>
                                        </optgroup>
                                        <?php } ?>
                                    </select>

                                    <input type="hidden" id="kodeAset" value="<?php echo $kodeAset; ?>"/>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="row" style="margin-top:20px;">
                    <div class="col-md-12" style="text-align:right;">
                        <button class='btn btn-success btn-rounded' id="editAset"><i class='fa fa-save'></i> Simpan</a>
                    </div>
                </div>
            </div>
        </div>
