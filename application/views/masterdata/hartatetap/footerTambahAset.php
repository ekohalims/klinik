...
<script type="text/javascript">
    ...
    $('#simpanAset').on("click",function(){
        ...
        $.ajax({
            method : "POST",
            url : "<?php echo base_url('hartaTetap/simpanAset'); ?>",
            data : {nama : nama, kelompokHarta : kelompokHarta, tanggalBeli : tanggalBeli, hargaBeli : hargaBeli,nilaiResidu : nilaiResidu,umurEkonomis : umurEkonomis,metode : metode,akunHarta : akunHarta,akumulasiDepresiasi : akumulasiDepresiasi,depresiasi : depresiasi},
            beforeSend : function(){
                $('#simpanAset').prop("disabled",true);
            },
            success : function(){
                $('#simpanAset').prop("disabled",false);
                $.Notification.autoHideNotify('success', 'top right', 'Berhasil!','Berhasil menambah Aset');
