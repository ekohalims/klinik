<div class="row">
	<div class="col-md-12" style="text-align: right;">
		<a class="btn btn-primary btn-rounded" href='#myModal' data-toggle="modal" id="loadItem"><i class="fa fa-cart-plus"></i> Tambah Diagnosa</a>
	</div>
</div>
...
<script type="text/javascript">
    ...
    $(document).on("click",".hapusCartDiag",function(){
    	var id = this.id;
    	var urlHapus = "<?php echo base_url('antrian/hapusCartDiag'); ?>";
    ...
    function tampilkanCartLab(){
    	var urlTampilkanCart = "<?php echo base_url('antrian/tampilkanCartDiagnosa'); ?>";
    ...
    function loadItem(){
        var urlItem = "<?php echo base_url('antrian/datatableDiagnosa'); ?>";
    ...
    function addDiagnosa(id,keterangan){
        var urlOrderLab = "<?php echo base_url('antrian/addDiagnosaOnPasien'); ?>";
    ...
    function tampilkanKeteranganDiagnosa(id){
        var urlCatatan = "<?php echo base_url('antrian/keteranganDiagnosa'); ?>";
