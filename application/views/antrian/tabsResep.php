<div class="row">
	<div class="col-md-12" style="text-align: right;">
		<a class="btn btn-success btn-rounded" href='#myModal' data-toggle="modal" id="loadItem"><i class="fa fa-cart-plus"></i> Tambah Resep</a>
	</div>
</div>
...
<script type="text/javascript">
    ...
    function tampilkanItemModal(idKategori,search,limitStart){
		var url = "<?php echo base_url('antrian/tampilkanItemObat'); ?>";
		$.ajax({
			method : "POST",
			url : url,
    ...
    $(document).on("click",".hapusResep",function(){
        ...
        var urlHapusResep = "<?php echo base_url('antrian/hapusResep'); ?>";
    ...
    function tampilkanCart(){
    	var urlTampilkanCart = "<?php echo base_url('antrian/tampilkanCartResep'); ?>";
